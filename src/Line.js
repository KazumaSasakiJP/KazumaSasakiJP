 ...
 **********************************************************************/
import './App.css';
import { AppBar, Button, Grid, LinearProgress, Paper, Slider, TextField, Toolbar, Typography, Snackbar, Alert, Hidden } from "@mui/material";
...
export const sendPower = (uselineParam, useOutPower, useSnackbar, useContext, powerUrl) => {
  ...
  if(DEMO_VERSION === true){
    ...
    setOutPower(prev=> {return{ ...prev, color: 'A400', sending: true }})
...
export const sendDir = (uselineParam, useOutDir, useSnackbar, useContext, dirUrl) => {
  ...
  if(DEMO_VERSION === true){
    ...
    setOutDir(prev=>{return{ ...prev, color: 'A400', sending: true }})
  ...
  return (
    <Fragment >
      ...
      <Grid container spacing={1} sx={{ p: 4 }}>
        <Grid item xs={12} xl={1} lg={2} md={3} sm={4}>
          <Button
            variant="contained"
        ...
        <Grid item xs={5} xl={1} lg={1} md={2} sm={2}>
          {"出力"}
        ...
        <Hidden mdDown>
          <Grid item xs={0} xl={8} lg={6} md={1} sm={1} />
        </Hidden>
        <Grid item xs={12} xl={1} lg={1} md={2} sm={2}>
          <Paper
            sx={{ p: 1, bgcolor: 'green', textAlign: 'center' }}
          >{lineParam.dir}</Paper>
        </Grid>
        <Grid item xs={12} xl={1} lg={2} md={3} sm={3}>
          <Button
            variant="contained"
            fullWidth
            onClick={(event) => {
        ...
        <Hidden lgDown>
          <Grid item xs={5} xl={8} lg={5} md={1} sm={6} />
        </Hidden>
        ...
        <Grid item xs={12} xl={1} lg={2} md={2} sm={3}>
          <Button
            variant="contained"
            fullWidth
            onClick={(event) => {
        ...
        <Grid item xs={6} xl={0.5} lg={1} md={1} sm={2}>
          <Button
            variant="contained"
            fullWidth
            onClick={(event) => {
        ...
        <Grid item xs={6} xl={0.5} lg={1} md={1} sm={1}>
          <Button
            variant="contained"
            fullWidth
            onClick={(event) => {
        ...
        <Grid item xs={6} xl={1} lg={1} md={1} sm={6}/>
        <Grid item xs={12}>
